...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var roundDownNum = Math.ceil(num);
  return roundDownNum;
}
...
agregarSimboloExclamacion('Hostia')
...
combinarNombres('James', 'Smith')

function obtenerSaludo(nombre) {
  // Toma la string "nombre" y concatena otras string en la cadena para que tome la siguiente forma:
  // "Martin" -> "Hola Martin!"
  // Tu código:
  var greet = `Hola ${nombre}!`;
  return greet;
}

obtenerSaludo('Charles')
